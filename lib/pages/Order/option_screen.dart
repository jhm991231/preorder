    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          List<DocumentSnapshot<Map<String, dynamic>>> optionDocs =
              snapshot.data!.docs;
          ...
          return Column(
            children: [
              ...
              ListView.builder(
                shrinkWrap: true,
                itemCount: optionDocs.length + 1,
                itemBuilder: (context, index) {
                  if (index == optionDocs.length) {
                    return ListTile(
                      title: const Text('내가 먹을 음료',
                      style: TextStyle(
                    ...
                    Map<String, dynamic> optionData =
                        optionDocs[index].data() as Map<String, dynamic>;
                    bool isChecked =
                        optionCheckStatus[optionData['optionName']] ?? false;
